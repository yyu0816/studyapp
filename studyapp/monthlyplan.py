...
def render_calendar_grid(year: int, month: int, plan_by_date: dict, start_date: date, end_date: date):
    ...
    div[data-testid="stHorizontalBlock"]:has(> div:nth-child(7)) div[data-testid="stVerticalBlockBorderWrapper"]::-webkit-scrollbar {
        width: 4px;
    }
    div[data-testid="stHorizontalBlock"]:has(> div:nth-child(7)) div[data-testid="stVerticalBlockBorderWrapper"]::-webkit-scrollbar-thumb {
